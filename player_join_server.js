...
module.exports = {
    messages: async (client, member) => {
        ...
        const en_message = `Welcome <@${member.id}> to the WFF Family! Please visit ${member.guild.channels.cache.get(importantChannelID).toString()} to customize the discord server to fit your language preferences.`;
